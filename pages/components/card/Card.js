...
export default function Card({ className, href }) {
    return (
        <Link href={href}>
            <div className={`${className} w-full rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 text-white`}>
                ...
                <div className="p-5">
                <span
                    className="bg-gray-100 text-gray-800 text-xs font-medium px-2.5 py-0.5 rounded mr-2 dark:bg-gray-700 dark:text-gray-300">
                    3 days ago
                </span>
                    <span
                        className="bg-blue-700 text-white text-xs font-medium px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">
                    Notice
                </span>
