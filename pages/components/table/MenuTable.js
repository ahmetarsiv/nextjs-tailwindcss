...
export default function MenuTable({ className, dateTime, examName, isActive }) {
    return (
        <Link href="">
            <div
                className={`${className} flex items-center border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-900 focus:bg-gray-100 w-full h-full p-5`}>
