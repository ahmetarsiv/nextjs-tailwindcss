        ...
        <div>
            ...
            <main className="py-16 grid justify-items-center">
                ...
                <div className="w-96 px-2">
                    ...
                    <form>
                        <Input type="email" placeholder="E-posta adresi veya kullanıcı adı" className="mb-2" required/>
                        <Input type="password" placeholder="Parola" className="mb-2" required/>
                    ...
                    <div className="flex flex-col">
                        ...
                        <button type="button" className="dark:text-white border hover:border-blue font-medium rounded-full text-lg py-2.5">
