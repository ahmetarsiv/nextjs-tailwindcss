                ...
                <section className="container mx-auto">
                    <div className="grid grid-cols-1 gap-1 md:grid-cols-1 md:gap-1 shadow-md pl-5">
                        <div>
                                <div className="bg-white shadow-md rounded-lg w-10 h-10 absolute right-5 md:right-44 p-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                                         stroke="currentColor" className="text-purple-800 w-6 h-6">
                            ...
                            <label className="mr-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     strokeWidth="1.5" stroke="currentColor" className="text-purple-800 w-12 h-12 float-left">
                                    <path strokeLinecap="round" strokeLinejoin="round"
                        ...
                        <div>
                            <label className="mr-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     strokeWidth="1.5" stroke="currentColor" className="text-purple-800 w-6 h-6 float-left">
                                    <path strokeLinecap="round" strokeLinejoin="round"
                    ...
                    <div className="grid grid-cols-1 gap-1 md:grid-cols-1 md:gap-1 shadow-md mt-20 pl-5">
                        <div>
                            ...
                            <label>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     strokeWidth="1.5" stroke="currentColor" className="text-purple-800 w-6 h-6 float-right">
                    ...
                    <div className="grid grid-cols-1 gap-1 md:grid-cols-1 md:gap-1 shadow-md mt-5 pl-5">
                        ...
                        <div className="my-5">
                            ...
                            <label>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 float-right">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5"/>
                                </svg>
                            </label>
                        </div>
                            ...
                            <svg width="25" height="25" viewBox="0 0 42 42" className="inline-block mb-1">
                                <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                    ...
                                    <g transform="translate(2.000000, 3.000000)">
                                        ...
                                        <circle stroke="currentColor" strokeWidth="2" cx="27.5" cy="27.5"
                                                r="7.5"></circle>
                                    </g>
                                </g>
                            </svg>
